...
#ifndef DROPPY_SWIFT_H
#define DROPPY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Droppy",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Droppy11AppDelegate")
...
SWIFT_CLASS("_TtC6Droppy19BasketDragContainer")
@interface BasketDragContainer : NSView
...
SWIFT_CLASS("_TtC6Droppy26DropBasketWindowController")
@interface DropBasketWindowController : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@class NSEvent;
SWIFT_CLASS("_TtC6Droppy18NotchDragContainer")
@interface NotchDragContainer : NSView
- (nonnull instancetype)initWithFrame:(NSRect)frameRect OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC6Droppy11NotchWindow")
...
SWIFT_CLASS("_TtC6Droppy21NotchWindowController")
@interface NotchWindowController : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// Manages the settings window for Droppy
SWIFT_CLASS("_TtC6Droppy24SettingsWindowController")
